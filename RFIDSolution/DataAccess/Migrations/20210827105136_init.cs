        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    REF_DOC_NO = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    REF_DOC_DATE = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "6ec9e633-fb30-43c5-a1c9-c2fb080f8134", false, "Admin", "ADMIN" });

            migrationBuilder.InsertData(
                table: "AspNetRoles",
                columns: new[] { "Id", "ConcurrencyStamp", "IsDeleted", "Name", "NormalizedName" },
                values: new object[] { 2, "d7916e0e-170c-4f90-b754-585d483807ad", false, "User", "USER" });
